...
public class XxlJobFileAppender {
	...
	public static void initLogPath(String logPath){
		...
		// mk resource dir
		File resourceBaseDir = new File(logPathDir, "resource");
	 ...
	 * @return
	 */
	public static String makeLogFileName(String triggerDate, int logId) {

		// filePath/yyyy-MM-dd
		File logFilePath = new File(getLogPath(), triggerDate.split(" ")[0]);
