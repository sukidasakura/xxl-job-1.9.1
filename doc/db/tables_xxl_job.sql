...
CREATE TABLE XXL_JOB_QRTZ_TRIGGER_RESOURCE
(
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fileName`  VARCHAR(200) NOT NULL COMMENT '资源名',
...
CREATE TABLE `XXL_JOB_QRTZ_TRIGGER_INFO` (
  ...
  `custom_param` varchar(1200) DEFAULT NULL COMMENT '(多个)自定义参数，需要转化为JSONObject取出',
  `resource_id` varchar(255) DEFAULT NULL COMMENT '依赖资源ID，多个逗号分隔',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
